...
If we were to compare this output to the one we would have gotten with the default null priors, we would find that the credible interval for the model with weakly informative priors has slightly tighter credible intervals and that the median has shifted slightly in the direction of the prior distributions we specified.
