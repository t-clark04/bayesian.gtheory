...
Now, we pass our variable, which I called `my_priors`, into the `prior` parameter of the `bayesian.gtheory` function call and otherwise run the analysis like normal. Feel free to change any of the default parameter values in your function. I'll just keep the default ones here for simplicity's sake.

```{r, echo = TRUE, results = "hide", message = FALSE, warning = FALSE}
results <- dstudy_p_nested1(data = sample_data, col.scores = "Score", col.subjects = "Person",
                            col.facet1 = "Item", col.facet2 = "Occasion", seq1 = seq(1,10,1), 
                            seq2 = seq(1,3,1), prior = my_priors)
```
